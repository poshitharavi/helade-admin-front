...
<head>
    ...
    <!-- DateTimePicker Css -->
    <link href="../template/plugins/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css"
          rel="stylesheet"/>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../index.php">
                        <span class="logo-minimized">HD</span>
                        <span class="logo">හෙළදේ</span>
                    </a>
                    <!-- #END# Logo -->
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown user-menu">
                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"><?PHP echo $_SESSION["heladeAdminShortName"];?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">
                                    <img src="../template/images/avatars/face2.jpg" alt="User Avatar" />
                                    <div class="user">
                                       <?PHP echo $_SESSION["heladeAdminShortName"];?>
